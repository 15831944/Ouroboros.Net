...
using Ouroboros.DbContexts.Mappings;
using System;
using System.Collections.Generic;
using System.Text;

namespace Ouroboros.DbContexts
{
    public class MSDbContext : DbContext
    {
        ...
        {
            modelBuilder.ApplyConfiguration(new SysLogrecordMap());
            modelBuilder.ApplyConfiguration(new SysRoleMap());
            modelBuilder.ApplyConfiguration(new SysUserLoginMap());
